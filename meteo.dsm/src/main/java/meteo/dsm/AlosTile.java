...
public class AlosTile
{
	...
	private String getCacheFilePath(int res, String type)
	{
		return new StringBuilder() 
				.append(cfg.getCacheDir()).append("/").append(res).append("/")
				.append("dsm_").append(type).append("_").append(res)
	...
	public DSMGrid toVectorArray(int res, LanduseProvider landuse)
	{
		...
		File demCacheFile = new File(getCacheFilePath(res, TYPE_DEM));
		File landuseCacheFile = new File(getCacheFilePath(res, TYPE_LANDUSE));
